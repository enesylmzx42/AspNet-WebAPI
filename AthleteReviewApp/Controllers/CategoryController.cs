...
namespace AthleteReviewApp.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        [HttpGet("Athlete/{categoryId}")]
        [ProducesResponseType(200, Type = typeof(IEnumerable<Athlete>))]
        [ProducesResponseType(400)]
        public IActionResult GetAthleteByCategoryId(int categoryId)
        {
            var Athletes = _mapper.Map<List<AthleteDto>>(
                _categoryRepository.GetAthleteByCategory(categoryId));
